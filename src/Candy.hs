...
normalEffect :: Effect
normalEffect = Effect "Normal" (Arbitrary [(Coordinate 0, Coordinate 0)]) (EffectRequirement Eq 0) "No special effect"
...
-- requirementP :: Parser EffectRequirement
-- requirementP = do
--     wsP $ pure ()
--     op <- operatorP <|> pure Eq
--     n <- wsP intP
--     return $ EffectRequirement op n
